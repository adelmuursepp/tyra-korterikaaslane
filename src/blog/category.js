  ...
  render() {
    ...
    return (
      <Layout>
        ...
        <div className="pv5 flex items-center justify-center bg-washed-blue">
          {/* <h1 className="fw1 tc f2 display"> {category}</h1> */}
        </div>
          ...
          <div className="pv5 flex w-100">
            {hasNext &&
                <Link
                  ...
                  to={this.props.pageContext.nextPage}>Järgmine leht &rarr;</Link>
            }
          </div>
        </div>
      </Layout>
